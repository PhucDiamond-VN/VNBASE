/*
		...
		(created by Omar,Fuck you Drake!!!!!!)
...
PlayAnim(playerid, const animlib[], const animname[], Float:fDelta, bool:loop, bool:lockx, bool:locky, bool:freeze, time, FORCE_SYNC:forcesync)
{
	ApplyAnimation(playerid, animlib, animname, fDelta, loop, lockx, locky, freeze, time, forcesync);
}

PlayAnimEx(playerid, const animlib[], const animname[], Float:fDelta, bool:loop, bool:lockx, bool:locky, bool:freeze, time, FORCE_SYNC:forcesync)
{
...
StopLoopingAnim(playerid)
{
    ...
    ApplyAnimation(playerid, "CARRY", "crry_prtial", 4.0, false, false, false, false, 0, FORCE_SYNC:1);
}

PreloadAnimLib(playerid, const animlib[])
{
	ApplyAnimation(playerid,animlib,"null",0.0,false, false, false, false, 0, FORCE_SYNC:1);
}
...
IsAblePedAnimation(playerid)
{
    ...
    {
		SendClientMessage(playerid, COLOR_GRAD2, "Hanh dong nay khong the thuc hien tren phuong tien.");
		return 0;
	}
	return 1;
}
...
public OnFilterScriptInit()
{
	...
	"~r~Phim cach (Space)~w~ de dung hanh dong");
...
CMD:animlist(playerid, params[])
{
	...
	SendClientMessage(playerid, COLOR_GREEN, "Nhan phim cach (space) de dung hanh dong.");
	return 1;
}
...
CMD:lowrider(playerid, params[])
{
	...
	{
		SendClientMessage(playerid, COLOR_GRAD2, "Hanh Dong nay yeu cau ban phai ngoi tren xe mui tran lowrider.");
	}
	return 1;
}
